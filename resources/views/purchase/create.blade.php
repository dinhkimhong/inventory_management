...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active p-3" id="vendor-data" role="tabpanel" aria-labelledby="vendor-data-tab">
        <div class="form-group row">
            ...
            <input type="text" name="payment_term" id="payment_term" class="form-control col-md-2">
        </div>

        <div class="form-group row">
            <label for="delivery_date" class="col-form-label col-md-2">Delivery Date</label>
            <input type="text" name="delivery_date" id="delivery_date" class="form-control col-md-2" placeholder="yyyy-mm-dd">
            ...
            <select name="delivery_term" id="delivery_term" class="form-control col-md-1 custom-select">
                ...
                <option value="{{ $delivery_term->delivery_term }}">{{ $delivery_term->delivery_term }}</option>
                @endforeach
            </select>
            <input type="text" name="delivery_place" id="delivery_place" class="form-control col-md-3" placeholder="place..">
        </div>  
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <input type="text" name="country" id="country" class="form-control col-md-2" readonly="true">
            <label for="contact" class="col-form-label col-md-2">Contact person</label>
            <input type="text" name="contact" id="contact" class="form-control col-md-2">
    ...
    <div class="tab-pane fade p-3" id="accounting" role="tabpanel" aria-labelledby="accounting-tab">
        ...
        <div class="form-group row">    
            ...
            <input type="text" name="total_freight_handling_cost" id="total_freight_handling_cost" class="form-control col-md-3" value="0">
        </div>
    ...
    <div class="tab-pane fade p-3" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">
        <div class="form-group">
            ...
            <textarea name="shipping_instruction" class="form-control" id="shipping_instruction" rows="7"></textarea>
        </div>
    </div>
