      ...
      <div class="container-fluid">
        <div class="row main_page justify-content-center align-items-center">
          <div class="col-10 col-md-5 mx-auto">
              <form class="log_in_form p-3" method="POST" action="{{ route('login') }}">
                <h3> Log In</h3>
                @csrf
                  ...
                  <a href="{{ route('registerPage') }}" class="btn btn-secondary">Sign Up</a>
                  <!-- <p>(*) Forgot password, <span> <a href="password/reset">click here</a></span> to reset</p> -->
              </form>
          </div>
        </div>
      </div>
